        ...
        {selectedProduct && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            <motion.div 
              ...
              className="bg-[#333333] w-full max-w-md rounded-3xl overflow-hidden shadow-2xl relative z-10"
            ...
            >
              ...
              {/* Large Image */}
              <div className="relative w-full h-72 bg-[#202020]">
              ...
              <div className="p-8 space-y-6">
                <div className="flex justify-between items-start gap-4 border-b border-[#DFD0B8]/10 pb-4">
                  <h2 className="text-3xl font-bold text-[#DFD0B8] font-serif leading-tight">
                    {selectedProduct.name}
                  </h2>
                  <span className="text-2xl font-bold text-[#DFD0B8] whitespace-nowrap font-serif">
                    {selectedProduct.price} {selectedProduct.currency}
                  </span>
                </div>
                
                {selectedProduct.description && (
                  <p className="text-[#DFD0B8]/80 leading-relaxed text-lg">
                    {selectedProduct.description}
                  </p>
                )}
              </div>
